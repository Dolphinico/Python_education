...
# Чтобы использовать любую функцию или класс из стандартной библиотеки,
# достаточно включить простую команду import в начало файла.
# Для примера рассмотрим класс OrderedDict из модуля collections.

# в качестве примера будет задействована старая программа favorite_language.py, но измененная.
