...
discribe_pets_1('dog', 'dogg') # Функция может вызываться в программе столько раз, сколько потребуется
...
describe_pet_3(pet_name='dogg') #что бы вывести имя любого другого животного, функция будет вызываться так:
