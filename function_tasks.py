...
# Печать моделей: выделите функции примера print_models.py 
# в отдельный файл с именем printing_functions.py
# Разместите команду import в начале файла print_models.py 
# и измените файл так, чтобы в нем использовались импортированные функции

print('\nУпражнение 8-16\n')

# за основу взят user_profile.py, программа в которую импортируется модуль - build_profile.py
# Импортирование: возьмите за основу одну из написанных вами программ с одной
# функцией Сохраните эту функцию в отдельном файле 
